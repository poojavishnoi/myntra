  ...
  return (
    <div className="md:p-6">
      ...
      <div className=" p-7 m-4 md:m-14 rounded-md text-center">
        <Link to='/productlist/all' className=" text-white bg-zinc-900 rounded-xl px-16 py-4  md:text-xl">
          View all
        </Link>
      ...
      <p className='absolute bottom-0 left-[30%] font-bold text-white text-2xl'>Women Clothing</p></div> */}
          <Link to='/productlist/women'  className="relative  transition duration-150 ease-out hover:ease-in hover:scale-105 cursor-pointer">
            <img
          ...
          <Link to="/productlist/men"  className="relative transition duration-150 ease-out hover:ease-in hover:scale-105 cursor-pointer ">
            <img
              className="rounded-md"
          ...
          <Link to="/productlist/kids"  className="relative transition duration-150 ease-out hover:ease-in hover:scale-105 cursor-pointer">
            <img
              className="rounded-md"
          ...
          <Link to="/productlist/footwear" className="relative transition duration-150 ease-out hover:ease-in hover:scale-105 cursor-pointer">
            <img
              className="rounded-md"
